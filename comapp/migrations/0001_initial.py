    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mbti', models.CharField(default='ISTJ', max_length=5, null=True)),
                ('meeting', models.BooleanField(default=True, null=True)),
                ('feedback', models.BooleanField(default=True, null=True)),
                ('ongoing', models.BooleanField(default=True, null=True)),
